...
for i in "${!all_embed_dim[@]}"; do
    ...
    python -m torch.distributed.launch --nproc_per_node=1 --master_port=21000 main_pretrain_metro_per_farm.py \
    ...
    --farm_type "wind" --farm_id "1000" \
    --output_dir ./checkpoints/wind-1000-$embed_dim/ 2>&1
